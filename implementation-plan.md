...
**2. Core Requirements** (as stated in the original `implementation-v0.2.md`)
...
**4. File Structure** (as stated in the original `implementation-v0.2.md`)
...
**5. Technologies** (as stated in the original `implementation-v0.2.md`)
...
**7. Communication:** (as stated in the original `implementation-v0.2.md`)
...
**8. Error Handling:** (as stated in the original `implementation-v0.2.md`)

*   Implement error handling (e.g., display error messages).

**9. Transparency Handling:** (as stated in the original `implementation-v0.2.md`)

*   `body` in `styles.css`: `background-color: transparent;`
*   `BrowserWindow`: `transparent: true`.
*   `iframe`: Fills the entire window.

**10. Animation Handling:** (as stated in the original `implementation-v0.2.md`)

*   Ensure `iframe` content is cleared before rendering new frames.
*   Guideline for loaded content: use `requestAnimationFrame`.

**11. Keyboard Shortcuts:** (as stated in the original `implementation-v0.2.md`)
